  ...
  return (
    <>
      ...
      <main className="container">
        ...
        <form onSubmit={handleSubmit} className="mb-4 mx-auto" style={{
          maxWidth:"600px"
        }}>
          <div className="mb-3">
            <label htmlFor="nombre" className="form-label fs-4 fw-bold">Nombre</label>
            <input
              type="text"
          ...
          <div className="mb-3">
            <label htmlFor="email" className="form-label fs-4 fw-bold">Correo Electrónico</label>
            <input
              type="email"
              className="form-control fs-5"
          ...
          <div className="mb-3">
            <label htmlFor="contrasena" className="form-label fs-4 fw-bold">Contraseña</label>
            <input
              type="password"
              className="form-control fs-5"
          ...
          <button type="submit" className="btn btn-primary container fs-4">Enviar</button>
        </form>
